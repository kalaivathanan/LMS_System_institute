                                        ...
                                        <div class="modal" id="registerStudentModal{{$paymentDetail->id}}"  role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content bg-success text-light">
                                                    ...
                                                    <form action="{{route('Admin.UpdatePayment', $paymentDetail->id)}}" method="post" >
                                                        @csrf
                                                        @method('post')
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group row align-items-center pt-4">
                                                                <label for="type" class="col-sm-3 col-form-label">{{$paymentDetail->type}}</label>
                                                                <div class="col-sm-3">
                                                                  ...
                                                                  <div class="col-sm-3">
                                                                        ...
                                                                        @if($paymentDetail->status == "paid")
                                                                    <input type="text" value="{{$paymentDetail->status}}" class="form-control" id="amount" name="" disabled>
                                                                        @else
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option value="request"{{$paymentDetail->status == "request" ? "selected" : ''}}>Request</option>
