...
@section('content')
    ...
    <div class="modal fade" id="rfidEntryModal" tabindex="-1" role="dialog" aria-labelledby="rfidEntryModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg-success text-light">
                    <div class="form-group">
                        ...
                        <label class="form-control text-capitalize" id="sid" disabled>
                    </div>
                    <div class="form-group">
                        <label for="sname">Student Name</label>
                        <label class="form-control text-capitalize" id="sname" disabled>
                    </div>
                    <div class="form-group" id='rfblock'>
                        <label for="rfidData">RFID Details</label>
                        <label class="form-control text-capitalize" id="rfidData" disabled>
                    </div>
                    <div class="form-group">
                        <label for="rfidStatus">Status</label>
                        <label class="form-control text-capitalize" id="rfidStatus" disabled>
                    </div>
                </div>
   ...
   function initiateRfidEntry(studentId,studentname) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                pollRfidEntryStatus(studentId, studentname);
                $('#rfblock').css('display', 'none');
