            ...
            <div class="col-md-10 col-sm-12 d-flex flex-column h-sm-100 p-0" id="cont">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="titleheader_">Student List of the Batch<span class='text-danger'> {{ $batch->course->name }} _
                                {{ $batch->id }}</span>
                        </h4>

                        <h5 class="float-right text-capitalize">&nbspBatch Status: {{ $batch->batchstatus }}</h5>
        ...
        $(document).ready(function() {
           ...
           var basefee={!! json_encode($batch->basepayment) !!}
            ...
            var batchtable=$('#dtable').DataTable({  
                ...
                ajax: {
                    url: '/get_Applicant/' +
                    batchId, // Pass the batch ID to the server to retrieve the data
                    data: function(d) {
                        d.batch_id = batchId;
